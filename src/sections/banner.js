  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      ...
      <Container sx={styles.container}>
        ...
        <Heading as="h1">Pixelate</Heading>
...
const styles = {
  banner: {
    position: 'relative', // Make sure the container is relative for the video to cover it
    textAlign: 'center',
    height:'100%',
    pt: ['110px', null, null, null, '130px'],
    pb: ['110px', null, null, null, '130px'],
  
    h1: {
      fontSize: ['60px', null, null, '60px', '68px', '68px', '64px'],
      lineHeight: 1.25,
      color: 'white',
      fontWeight: 700,
      width: '100%',
