...
import { jsx, Box, Text, Container, img } from 'theme-ui';
  ...
  return (
    <Box as="footer" sx={styles.footer}>
      <Container sx={styles.container}>
        ...
        >
          <img src={logoLight} alt="Logo" style={{ width: '160px', padding:'10px'}} />
          <Text
            as="p"
            sx={{
              color: '#ffffff',
          ...
          >
            Copyrights by {new Date().getFullYear()} Pixelate Creations, Inc
          </Text>
        </Box>
